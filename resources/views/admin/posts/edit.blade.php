                ...
                <div class="grid gap-8 lg:grid-cols-[18rem_1fr]">
                    <aside class="space-y-6">
                        ...
                        <label class="flex items-start gap-3 rounded-md border border-gray-200 px-4 py-3 text-sm dark:border-gray-700">
                            <input id="breaking_news" name="breaking_news" type="checkbox" value="1" @checked(old('breaking_news', $post->breaking_news)) class="mt-0.5 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                            <span>
